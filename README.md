## Практическое задание для вакансии Cтажер-разработчик Python/C# (Data Engineer)

### Задание 1 (Для запуска использовать main_1.py):
...
### Задание 2 (Для запуска использовать main_2.py):
